"""
Collect scheme URLs for the category "Transport & Infrastructure" from MyScheme.gov.in.
Saves to data/transport_infrastructure_urls.json.

Run from project root:
  python collect_transport_infrastructure_urls.py
"""
...
OUTPUT_PATH = "data/transport_infrastructure_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/transport_infrastructure_urls_partial.json"
