"""
Collect scheme URLs for the category "Education & Learning" from MyScheme.gov.in.
Saves to data/education_learning_urls.json.

Run from project root:
  python collect_education_learning_urls.py
"""
...
BASE_URL = "https://www.myscheme.gov.in/search/category/Education%20&%20Learning"
OUTPUT_PATH = "data/education_learning_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/education_learning_urls_partial.json"
