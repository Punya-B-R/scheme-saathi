"""
Collect scheme URLs for the category "Science, IT & Communications" from MyScheme.gov.in.
Saves to data/science_it_communications_urls.json.

Run from project root:
  python collect_science_it_urls.py
"""
...
OUTPUT_PATH = "data/science_it_communications_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/science_it_communications_urls_partial.json"
