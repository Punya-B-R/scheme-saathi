"""
Collect scheme URLs for the category "Sports & Culture" from MyScheme.gov.in.
Saves to data/sports_culture_urls.json.

Run from project root:
  python collect_sports_culture_urls.py
"""
...
OUTPUT_PATH = "data/sports_culture_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/sports_culture_urls_partial.json"
