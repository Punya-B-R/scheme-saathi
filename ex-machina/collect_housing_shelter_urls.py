"""
Collect scheme URLs for the category "Housing & Shelter" from MyScheme.gov.in.
Saves to data/housing_shelter_urls.json.

Run from project root:
  python collect_housing_shelter_urls.py
"""
...
OUTPUT_PATH = "data/housing_shelter_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/housing_shelter_urls_partial.json"
