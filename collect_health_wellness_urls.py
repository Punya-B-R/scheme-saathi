"""
Collect scheme URLs for the category "Health & Wellness" from MyScheme.gov.in (28 pages).
Saves to data/health_wellness_urls.json.

Run from project root:
  python collect_health_wellness_urls.py
"""
...
OUTPUT_PATH = "data/health_wellness_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/health_wellness_urls_partial.json"
