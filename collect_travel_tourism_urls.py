"""
Collect scheme URLs for the category "Travel & Tourism" from MyScheme.gov.in.
Saves to data/travel_tourism_urls.json.

Run from project root:
  python collect_travel_tourism_urls.py
"""
...
OUTPUT_PATH = "data/travel_tourism_urls.json"
...
def main():
    ...
    try:
        ...
        print("\nInterrupted.")
        if collected:
            out_path = "data/travel_tourism_urls_partial.json"
